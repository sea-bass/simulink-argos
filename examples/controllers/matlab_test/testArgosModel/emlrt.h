 ...
 */
#define EMLRT_VERSION_R2018B 0x2018B
#define EMLRT_VERSION_INFO EMLRT_VERSION_R2018B
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtSetAllProperties(emlrtConstCTX aTLS,
                                                 const mxArray** mxClass,
                                                 int32_T aIndex,
                                                 int32_T propCount,
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtGetAllProperties(emlrtConstCTX aTLS,
                                                 const mxArray* mxCls,
                                                 int32_T aIndex,
                                                 int32_T propCount,
                                                 const char** propNames,
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtSerializeInitialize(boolean_T isDeserialize,
                                                    boolean_T isVerification,
                                                    const char* projectName,
                                                    uint32_T aCheckSumLen,
